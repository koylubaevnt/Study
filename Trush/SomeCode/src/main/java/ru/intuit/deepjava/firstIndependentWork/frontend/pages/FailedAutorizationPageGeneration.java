...
public class FailedAutorizationPageGeneration implements PageGenerator {
	...
	public String getPage(UserSession userSession) {
		...
		sb.append("<html>\n")
		.append("<head>\n")
		.append("<title>Ошибка авторизации</title>\n")
		.append("</head>\n")
		.append("<body>\n")
		...
		.append("Такого пользователя не существует.<br/>\n")
