...
public class CardOperation implements Serializable {
	...
	public CardOperation(String card, double amount, BillingOperationType operationType, LocalDate operationDate) {
		this.card = card;
		this.amount = amount;
	...
	public BillingOperationType getOperationType() {
		return operationType;
	}
	public void setOperationType(BillingOperationType operationType) {
		this.operationType = operationType;
	}
