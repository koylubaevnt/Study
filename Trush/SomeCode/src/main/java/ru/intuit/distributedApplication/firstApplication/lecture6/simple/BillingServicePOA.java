...
/**
* ru/intuit/distributedApplication/firstApplication/lecture6/simple/BillingServicePOA.java .
...
public abstract class BillingServicePOA extends org.omg.PortableServer.Servant
 implements ru.intuit.distributedApplication.firstApplication.lecture6.simple.BillingServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  // U W! µ ? µ » µ  Q µ CORBA-! U  X µ!! Q X U V U ! µ!  Q! °
       case 0:  // simple/BillingService/addNewCard
       {
       ...
       case 1:  // simple/BillingService/addMoney
       {
         String card = in.read_string ();
       ...
       case 2:  // simple/BillingService/subMoney
       {
         String card = in.read_string ();
         double money = in.read_double ();
       ...
       case 3:  // simple/BillingService/getCardBalance
       {
         String card = in.read_string ();
