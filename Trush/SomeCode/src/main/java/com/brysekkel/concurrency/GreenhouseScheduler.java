...
public class GreenhouseScheduler {
	...
	public void repeat(Runnable event, long delay, long perion) {
		scheduler.scheduleAtFixedRate(event, delay, perion, TimeUnit.MILLISECONDS);
	}
	...
	class Terminate implements Runnable {
		...
		public void run() {
			...
			//Запускаем отдельную задачу, т.к. планировщик завершен
			new Thread() {
				@Override
				public void run() {
