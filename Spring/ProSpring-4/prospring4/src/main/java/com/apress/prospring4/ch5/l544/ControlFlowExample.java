package com.apress.prospring4.ch5.l544;
...
public class ControlFlowExample {
	...
	public void run() {
		...
		proxy.foo();
		System.out.println("Trying under ControlFlowExample.test() invoke");
		test(proxy);
		System.out.println("Trying under ControlFlowExample.other() invoke");
		other(proxy);
	}
	...
	private void other(TestBean bean) {
		bean.foo();
	}
}
