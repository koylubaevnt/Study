...
/**
 * Created by KoylubaevNT on 26.09.2017.
 */

public final class QuertyUtils {

    public static final String LOG_TAG = QuertyUtils.class.getName();
    ...
    private static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                JSONObject earthquakeJsonObject = jsonArray.optJSONObject(i);
