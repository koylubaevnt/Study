...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int иreedColumnIndex = cursor.getColumnIndex(PetEntry.COLUMN_BREED);
            ...
            String breed = cursor.getString(иreedColumnIndex);
    ...
    private void savePet() {
        ...
        contentValues.put(PetEntry.COLUMN_NAME, name);
        contentValues.put(PetEntry.COLUMN_BREED, breed);
        contentValues.put(PetEntry.COLUMN_GENDER, mGender);
        ...
        contentValues.put(PetEntry.COLUMN_WEIGHT, weight);
        ...
        if(mCurrentPetUri != null) {
            ...
            // we want to modify.
            int rowsAffected = getContentResolver().update(PetEntry.CONTENT_URI, contentValues, null, null);
            ...
            // Otherwise this is a NEW pet, so insert a new pet into the provider,
